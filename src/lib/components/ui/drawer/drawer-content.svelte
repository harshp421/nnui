<script lang="ts">
	...
	import type { WithoutChildrenOrChild } from "$lib/utils/tailwindUtil.js";
...
<DrawerPortal {...portalProps}>
	...
	<DrawerPrimitive.Content
		...
		class={cn(
			"group/drawer-content bg-background fixed z-50 flex h-auto flex-col glass:backdrop-blur-xl glass:backdrop-saturate-150",
	...
	>
		<div
			class="bg-alpha-viceversa-black-200 mx-auto mt-4 hidden h-4 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
		></div>
		{@render children?.()}
	</DrawerPrimitive.Content>
</DrawerPortal>
