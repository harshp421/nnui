...
<TooltipPrimitive.Portal>
  <TooltipPrimitive.Content
    ...
    {side}
    class={cn(
      "bg-tool-tip-body text-tool-tip-text text-xs font-medium glass:backdrop-blur-xl glass:backdrop-saturate-150",
  ...
  >
    ...
    <TooltipPrimitive.Arrow>
      {#snippet child({ props })}
        <div
          class={cn(
            "bg-tool-tip-body z-50 size-2.5 rotate-45 rounded-2",
